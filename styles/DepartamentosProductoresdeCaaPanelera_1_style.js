...
var style_DepartamentosProductoresdeCaaPanelera_1 = function(feature, resolution){
    ...
    if (value > 1.800000 && value <= 3.560000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3.560000 && value <= 5.320000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 5.320000 && value <= 7.080000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 7.080000 && value <= 8.840000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 8.840000 && value <= 10.600000) {
            style = [ new ol.style.Style({
